...
- Model hyperparameters tuned for **Addition task** with drastically reduced heads/layers for compute efficiency (significantly lower than paper reported values)
